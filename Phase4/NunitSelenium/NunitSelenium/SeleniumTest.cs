...

{
...

    {
...

        {
            ...
            driver.Navigate().GoToUrl("https://www.browserstack.com/contact?ref=footer");

            IWebElement contactPageHeader = driver.FindElement(By.TagName("title"));

            Assert.IsTrue(contactPageHeader.Text.Contains("get in touch"));
